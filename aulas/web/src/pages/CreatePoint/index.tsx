...
// SEMPRE que um estado for criado para Array ou Objeto: 
// need necessário informar o tipo de variável que será armazenada ali dentro.
...
const CreatePoint = () =>{
    ...
    useEffect(() =>{      
        if(selectedUf === "0"){   //Carrega as cidades sempre que a UF mudar
            return;
        }
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    <legend>
                        ...
                        <span>
                            Selecione um ou mais ìtens abaixo:
                        </span>
                    </legend>
